<template>
    <div class="bg-[#F8F8F7] relative flex justify-center items-center min-h-screen lg:mt-0 mt-10">
        ...
        <!-- Main Content -->
        <div class="flex flex-col items-center w-full px-4 py-10 lg:my-36 z-10">
            <!-- Heading -->
            <p class="text-site-grey-secondary text-xl lg:text-2xl font-medium mb-6 lg:mb-10">اعادة ضبط الرقم السري</p>
            ...
            <form class="w-full max-w-[400px]">
                ...
                <RouterLink
                    to="otp"
                    class="w-full py-3 lg:py-5 bg-site-primary text-white rounded-full mt-5 block text-center"
                >
                    تأكيد
                </RouterLink>
